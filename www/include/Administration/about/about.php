        ...
        <table class="table">
            <tr>
                <td>
                    ...
                    <!-- <p>
                        <em>(commit&nbsp;
                            <a href="https://github.com/centreon/centreon/tree/30648076a6">30648076a6</a>)
                        </em>
                    </p><br> -->
                </td>
                <td>
                    Developed by
                    <a href="http://www.synergysis.com/">Synergy Information Systems</a>
                </td>
                <td style="text-align: center" rowspan="3">
                    <img src="./img/logo-sipmon.png" alt="logo Sipmon" />
                </td>
            </tr>
            <!-- <tr>
